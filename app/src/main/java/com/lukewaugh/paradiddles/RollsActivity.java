...
import com.lukewaugh.paradiddles.swipeAdapters.RollsSwipeAdapter;


@SuppressWarnings("deprecation")
public class RollsActivity extends AppCompatActivity implements
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.settings) {
            Intent intent = new Intent(RollsActivity.this, SettingsActivity.class);
            startActivity(intent);
        } else if (id == R.id.account) {
            Intent intent = new Intent(RollsActivity.this, LoginActivity.class);
            startActivity(intent);
        } else if (id == R.id.home) {
            Intent intent = new Intent(RollsActivity.this, MainActivity.class);
            startActivity(intent);
        }
