...
public class FlamsActivity extends AppCompatActivity implements
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.settings) {
            Intent intent = new Intent(FlamsActivity.this, SettingsActivity.class);
            startActivity(intent);
        } else if (id == R.id.account) {
            Intent intent = new Intent(FlamsActivity.this, LoginActivity.class);
            startActivity(intent);
        } else if (id == R.id.home) {
            Intent intent = new Intent(FlamsActivity.this, MainActivity.class);
            startActivity(intent);
        }
